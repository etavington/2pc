...
const (
	TwoPhaseCommitService_CreateAccount_FullMethodName    = "/grpc_2pc.TwoPhaseCommitService/CreateAccount"
	TwoPhaseCommitService_DeleteAccount_FullMethodName    = "/grpc_2pc.TwoPhaseCommitService/DeleteAccount"
	TwoPhaseCommitService_ReadAccount_FullMethodName      = "/grpc_2pc.TwoPhaseCommitService/ReadAccount"
	TwoPhaseCommitService_UpdateAccount_FullMethodName    = "/grpc_2pc.TwoPhaseCommitService/UpdateAccount"
	TwoPhaseCommitService_BeginTransaction_FullMethodName = "/grpc_2pc.TwoPhaseCommitService/BeginTransaction"
	TwoPhaseCommitService_Commit_FullMethodName           = "/grpc_2pc.TwoPhaseCommitService/Commit"
	TwoPhaseCommitService_Abort_FullMethodName            = "/grpc_2pc.TwoPhaseCommitService/Abort"
	TwoPhaseCommitService_Reset_FullMethodName            = "/grpc_2pc.TwoPhaseCommitService/Reset"
)
...
type TwoPhaseCommitServiceClient interface {
	...
	Reset(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*Response, error)
}
...
func (c *twoPhaseCommitServiceClient) CreateAccount(ctx context.Context, in *CreateAccountRequest, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, TwoPhaseCommitService_CreateAccount_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *twoPhaseCommitServiceClient) DeleteAccount(ctx context.Context, in *DeleteAccountRequest, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, TwoPhaseCommitService_DeleteAccount_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *twoPhaseCommitServiceClient) ReadAccount(ctx context.Context, in *ReadAccountRequest, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, TwoPhaseCommitService_ReadAccount_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *twoPhaseCommitServiceClient) UpdateAccount(ctx context.Context, in *UpdateAccountRequest, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, TwoPhaseCommitService_UpdateAccount_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *twoPhaseCommitServiceClient) BeginTransaction(ctx context.Context, in *BeginTransactionRequest, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, TwoPhaseCommitService_BeginTransaction_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *twoPhaseCommitServiceClient) Abort(ctx context.Context, in *AbortRequest, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, TwoPhaseCommitService_Abort_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *twoPhaseCommitServiceClient) Reset(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, TwoPhaseCommitService_Reset_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TwoPhaseCommitServiceServer interface {
	...
	Reset(context.Context, *emptypb.Empty) (*Response, error)
...
func (UnimplementedTwoPhaseCommitServiceServer) Reset(context.Context, *emptypb.Empty) (*Response, error) {
...
func _TwoPhaseCommitService_CreateAccount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TwoPhaseCommitService_CreateAccount_FullMethodName,
	}
...
func _TwoPhaseCommitService_DeleteAccount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TwoPhaseCommitService_DeleteAccount_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _TwoPhaseCommitService_ReadAccount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TwoPhaseCommitService_ReadAccount_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _TwoPhaseCommitService_UpdateAccount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TwoPhaseCommitService_UpdateAccount_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _TwoPhaseCommitService_BeginTransaction_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TwoPhaseCommitService_BeginTransaction_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _TwoPhaseCommitService_Abort_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TwoPhaseCommitService_Abort_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _TwoPhaseCommitService_Reset_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TwoPhaseCommitService_Reset_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TwoPhaseCommitServiceServer).Reset(ctx, req.(*emptypb.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
var TwoPhaseCommitService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "Server3/grpc_2pc/two-phase-commit.proto",
}
